...
// */
//public class MemoryRecords extends org.apache.kafka.common.record.AbstractRecords {
...
//
//        int bytes = 0;
//        for (org.apache.kafka.common.record.RecordBatch batch : batches())
...
//            final RecordFilter.BatchRetentionResult batchRetentionResult = filter.checkBatchRetention(batch);
//            final boolean containsMarkerForEmptyTxn = batchRetentionResult.containsMarkerForEmptyTxn;
//            final RecordFilter.BatchRetention batchRetention = batchRetentionResult.batchRetention;
//
...
//            List<org.apache.kafka.common.record.Record> retainedRecords = new ArrayList<>();
//
...
//                boolean needToSetDeleteHorizon = batch.magic() >= org.apache.kafka.common.record.RecordBatch.MAGIC_VALUE_V2 && (containsTombstones || containsMarkerForEmptyTxn)
...
//                    else
//                        deleteHorizonMs = batch.deleteHorizonMs().orElse(org.apache.kafka.common.record.RecordBatch.NO_TIMESTAMP);
...
//                if (batchMagic < org.apache.kafka.common.record.RecordBatch.MAGIC_VALUE_V2)
...
//    }
//
//    private static BatchFilterResult filterBatch(org.apache.kafka.common.record.RecordBatch batch,
//                                                 BufferSupplier decompressionBufferSupplier,
//                                                 FilterResult filterResult,
//                                                 RecordFilter filter,
//                                                 byte batchMagic,
//                                                 boolean writeOriginalBatch,
//                                                 List<org.apache.kafka.common.record.Record> retainedRecords) {
//        long maxOffset = -1;
//        boolean containsTombstones = false;
//        try (final CloseableIterator<org.apache.kafka.common.record.Record> iterator = batch.streamingIterator(decompressionBufferSupplier)) {
...
//    }
//
//    private static MemoryRecordsBuilder buildRetainedRecordsInto(org.apache.kafka.common.record.RecordBatch originalBatch,
//                                                                 List<org.apache.kafka.common.record.Record> retainedRecords,
...
//                originalBatch.maxTimestamp() : org.apache.kafka.common.record.RecordBatch.NO_TIMESTAMP;
//        long baseOffset = magic >= org.apache.kafka.common.record.RecordBatch.MAGIC_VALUE_V2 ?
...
//
//        for (org.apache.kafka.common.record.Record record : retainedRecords)
//            builder.append(record);
//
//        if (magic >= org.apache.kafka.common.record.RecordBatch.MAGIC_VALUE_V2)
...
//         */
//        protected abstract BatchRetentionResult checkBatchRetention(org.apache.kafka.common.record.RecordBatch batch);
//
//        /**
//         * Check whether a record should be retained in the log. Note that {@link #checkBatchRetention(org.apache.kafka.common.record.RecordBatch)}
...
//         */
//        protected abstract boolean shouldRetainRecord(org.apache.kafka.common.record.RecordBatch recordBatch, Record record);
//    }
//
...
//        private long maxTimestamp = org.apache.kafka.common.record.RecordBatch.NO_TIMESTAMP;
...
//            if (maxTimestamp != org.apache.kafka.common.record.RecordBatch.NO_TIMESTAMP && shallowOffsetOfMaxTimestamp < 0)
...
//                                               long baseOffset) {
//        return builder(buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, compressionType, timestampType, baseOffset);
//    }
//
//    public static MemoryRecordsBuilder builder(ByteBuffer buffer,
//                                               CompressionType compressionType,
...
//                                               long baseOffset,
//                                               int maxSize) {
//        long logAppendTime = org.apache.kafka.common.record.RecordBatch.NO_TIMESTAMP;
//        if (timestampType == TimestampType.LOG_APPEND_TIME)
//            logAppendTime = System.currentTimeMillis();
//
//        return new MemoryRecordsBuilder(buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, compressionType, timestampType, baseOffset,
//            logAppendTime, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE,
//            false, false, org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH, maxSize);
//    }
//
...
//                                                         short producerEpoch,
//                                                         int baseSequence) {
//        return builder(buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, compressionType, TimestampType.CREATE_TIME,
...
//                org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE, false,
...
//        return builder(buffer, magic, compressionType, timestampType, baseOffset, logAppendTime,
//                org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE, false, partitionLeaderEpoch);
//    }
//
//    public static MemoryRecordsBuilder builder(ByteBuffer buffer,
//                                               CompressionType compressionType,
...
//        return builder(buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, compressionType, TimestampType.CREATE_TIME, baseOffset,
//                org.apache.kafka.common.record.RecordBatch.NO_TIMESTAMP, producerId, producerEpoch, baseSequence, isTransactional,
//                org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH);
//    }
//
//    public static MemoryRecordsBuilder builder(ByteBuffer buffer,
...
//                                               int baseSequence) {
//        return builder(buffer, magic, compressionType, timestampType, baseOffset, logAppendTime,
//                producerId, producerEpoch, baseSequence, false, org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH);
//    }
//
//    public static MemoryRecordsBuilder builder(ByteBuffer buffer,
//                                               byte magic,
...
//        return withRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, compressionType, records);
//    }
//
//    public static MemoryRecords withRecords(CompressionType compressionType, int partitionLeaderEpoch, SimpleRecord... records) {
//        return withRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, 0L, compressionType, TimestampType.CREATE_TIME,
//                org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE,
...
//        return withRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, initialOffset, compressionType, TimestampType.CREATE_TIME,
//                records);
//    }
//
...
//        return withRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, initialOffset, compressionType, TimestampType.CREATE_TIME, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID,
//                org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE, partitionLeaderEpoch, false, records);
//    }
//
...
//        return withRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, 0L, compressionType, TimestampType.CREATE_TIME, producerId, producerEpoch,
//                baseSequence, org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH, false, records);
//    }
//
...
//                                                         short producerEpoch, int baseSequence, SimpleRecord... records) {
//        return withRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, 0L, compressionType, TimestampType.CREATE_TIME,
//                producerId, producerEpoch, baseSequence, org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH, true, records);
//    }
//
...
//                                                         short producerEpoch, int baseSequence, int partitionLeaderEpoch,
//                                                         SimpleRecord... records) {
//        return withTransactionalRecords(org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, initialOffset, compressionType,
...
//        return withRecords(magic, initialOffset, compressionType, timestampType, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID,
//                org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE, org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH,
//                false, records);
//    }
//
//    public static MemoryRecords withRecords(byte magic, long initialOffset, CompressionType compressionType,
...
//        return withEndTransactionMarker(0L, System.currentTimeMillis(), org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH,
...
//        return withEndTransactionMarker(0L, timestamp, org.apache.kafka.common.record.RecordBatch.NO_PARTITION_LEADER_EPOCH, producerId,
...
//        try (MemoryRecordsBuilder builder = new MemoryRecordsBuilder(buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, CompressionType.NONE,
//                TimestampType.CREATE_TIME, initialOffset, timestamp, producerId, producerEpoch,
//                org.apache.kafka.common.record.RecordBatch.NO_SEQUENCE, isTransactional, true, partitionLeaderEpoch,
//                buffer.capacity())
//        ) {
...
//            buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, CompressionType.NONE,
...
//            buffer, org.apache.kafka.common.record.RecordBatch.CURRENT_MAGIC_VALUE, CompressionType.NONE,
//            TimestampType.CREATE_TIME, initialOffset, timestamp,
//            org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_ID, org.apache.kafka.common.record.RecordBatch.NO_PRODUCER_EPOCH, RecordBatch.NO_SEQUENCE,
//            false, true, leaderEpoch, buffer.capacity())
//        ) {
