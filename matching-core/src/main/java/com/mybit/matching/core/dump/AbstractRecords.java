...
//
//    private final Iterable<org.apache.kafka.common.record.Record> records = this::recordsIterator;
//
//    @Override
...
//        Iterator<? extends org.apache.kafka.common.record.RecordBatch> iterator = batches().iterator();
//
//        if (!iterator.hasNext())
//            return null;
//
...
//
//    @Override
//    public Optional<org.apache.kafka.common.record.RecordBatch> lastBatch() {
//        Iterator<? extends org.apache.kafka.common.record.RecordBatch> iterator = batches().iterator();
//
//        org.apache.kafka.common.record.RecordBatch batch = null;
...
//    }
//
//    private Iterator<org.apache.kafka.common.record.Record> recordsIterator() {
//        return new AbstractIterator<org.apache.kafka.common.record.Record>() {
//            private final Iterator<? extends org.apache.kafka.common.record.RecordBatch> batches = batches().iterator();
//            private Iterator<org.apache.kafka.common.record.Record> records;
//
//            @Override
//            protected org.apache.kafka.common.record.Record makeNext() {
...
//                                          Iterable<org.apache.kafka.common.record.Record> records) {
//        int size = 0;
//        if (magic <= org.apache.kafka.common.record.RecordBatch.MAGIC_VALUE_V1) {
